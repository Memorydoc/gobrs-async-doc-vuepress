...
[**Gobrs-Async**](https://github.com/Memorydoc/gobrs-async) 是一款功能强大、配置灵活、带有全链路异常回调、内存优化、异常状态管理于一身的高性能并发编程与动态编排框架。为企业提供在复杂应用场景下动态任务编排的能力。
针对于复杂场景下，异步多线程任务的复杂性、任务之前的依赖性、同时多线程异常状态难以控制的特性； **Gobrs-Async** 为此而生。
